...
import { Music, Search, X, ChevronDown, Play, Youtube } from 'lucide-react'
...
export default function Musicas() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', backgroundColor: '#ffffff', fontFamily: "'Poppins', sans-serif" }}>
      ...
      {/* Header */}
      <div style={{ backgroundColor: '#3a2a1a', padding: '24px 20px 20px' }}>
        ...
        <h1 style={{ margin: '4px 0 0', fontSize: 22, fontWeight: 800, color: '#ffffff' }}>Músicas e Pontos</h1>
      </div>
